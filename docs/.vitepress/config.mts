          ...
          '/zh-CN/guide/': [
            {
              ...
              items: [
                ...
                { text: '模型工具评测', link: '/zh-CN/guide/model-tool-evaluation' },
                { text: '工具命名契约', link: '/zh-CN/guide/tool-naming' },
                { text: '资源句柄', link: '/zh-CN/guide/resource-handles' },
      ...
      '/guide/': [
        {
          ...
          items: [
            ...
            { text: 'Model Tool Evaluation', link: '/guide/model-tool-evaluation' },
            { text: 'Tool Naming Contract', link: '/guide/tool-naming' },
