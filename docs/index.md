...
features:
  - icon:
      src: /icons/tools.svg
    title: 43 MCP Tools
    details: Camera control, GeoJSON layers, 3D Tiles, terrain, imagery, entity management, trajectory animation, heatmaps, and more — organized into 10 toolsets with dynamic discovery.
  - icon:
...
| [`cesium-mcp-runtime`](https://www.npmjs.com/package/cesium-mcp-runtime) | MCP Server — 43 tools (10 toolsets) and 2 resources for AI agents | [![npm](https://img.shields.io/npm/v/cesium-mcp-runtime?color=1a1a2e&labelColor=e2e8f0)](https://www.npmjs.com/package/cesium-mcp-runtime) |
