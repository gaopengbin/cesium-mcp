...
Built-in view, entity, layer, and camera executors are organized by domain. The remaining domains migrate incrementally while the public `execute()` and per-command override contract remain stable.
